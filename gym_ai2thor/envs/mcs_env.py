...
class McsEnv:
    ...
    def __init__(self, task=None, scene_type=None, seed=None, start_scene_number=0):
        ...
        if platform.system() == "Linux":
            config_file_folder = "/home/rajesh/rajesh/mcs_data/interaction_scenes_divided/"
        elif platform.system() == "Darwin":
            config_file_folder = "/Users/rajesh/Rajesh/Subjects/Research/aiThor/interaction_scenes_divided/"

        if task and scene_type:
           #goal_dir = os.path.join(task, scene_type)
            goal_dir = config_file_folder + scene_type
