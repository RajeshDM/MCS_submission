...
if __name__ == "__main__":
    ...
    #env = McsEnv(task="interaction_scenes", scene_type="retrieval", start_scene_number= 302)
    env = McsEnv(task="interaction_scenes", scene_type='traversal', start_scene_number=655)
    ...
    if True:
        ...
        #        str(game_state.number_actions)+ ",exploration_success," + str(game_state.goals_found) + ",total success,"+ str(result_total)+",total actions until now"+ str(total_actions)  +"\n")
